...
// Client spricht mit der lokal laufenden OBS-Instanz und hält die Verbindung
// über einen Reconnect-Loop offen.
type Client struct {
	host           string
	port           int
	password       string
...
// NewClient creates a new OBS client for the local OBS instance
