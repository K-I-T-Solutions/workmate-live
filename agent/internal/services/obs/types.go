...
// Die Typen in diesem Paket spiegeln portal/backend/internal/services/obs/types.go.
// Beide Seiten sind eigene Go-Module, daher ist die JSON-Repräsentation der Vertrag —
// Feldnamen und Tags müssen identisch bleiben.
